...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::patch('/notifications/{adminNotification}/read', [NotificationController::class, 'read'])->name('notifications.read');
        Route::delete('/notifications/{adminNotification}', [NotificationController::class, 'destroy'])->name('notifications.destroy');
