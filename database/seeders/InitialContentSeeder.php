...
class InitialContentSeeder extends Seeder
{
    public function run(): void
    {
        $institutions = [
            ...
            ['name' => 'C-Net Pathshala', 'website_url' => 'https://c-net.bsss.mciedu.com', 'short_description' => 'Digital and academic learning platform for students.', 'display_order' => 3],
            ...
            ['name' => 'C-Net Web Services', 'website_url' => 'https://web.bsss.mciedu.com', 'short_description' => 'Website, digital presence and related web services.', 'display_order' => 5],
        ];
        ...
        $settings = [
            'site_name' => 'Bharatiya Swatantra Shikshan Sangh',
