...
@section('title', 'Gallery | Bharatiya Swatantra Shikshan Sangh')
...
<section class="page-hero py-5 bg-light border-bottom">
    <div class="container py-4">
        ...
        <p class="lead text-secondary mb-0">Photos and highlights from classrooms, events, training programs and activities across Bharatiya Swatantra Shikshan Sangh.</p>
    </div>
</section>
<section class="py-5">
    <div class="container">
