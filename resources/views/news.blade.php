...
@section('title', 'News & Events | Bharatiya Swatantra Shikshan Sangh')
...
<section class="page-hero py-5 bg-light border-bottom">
    <div class="container py-4">
        ...
        <p class="lead text-secondary mb-0">Latest announcements, academic updates, activities and events from Bharatiya Swatantra Shikshan Sangh and its institutions.</p>
    </div>
</section>
<section class="py-5">
    <div class="container">
