...
<head>
    ...
    @php
        $seoTitle = trim($__env->yieldContent('title', 'Bharatiya Swatantra Shikshan Sangh'));
        $seoDescription = trim($__env->yieldContent('meta_description', 'Bharatiya Swatantra Shikshan Sangh - An Institution With Global Reach'));
...
<nav class="navbar navbar-expand-lg bg-white sticky-top shadow-sm">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('home') }}">
            <img src="{{ $logoUrl }}" alt="Bharatiya Swatantra Shikshan Sangh logo" class="brand-logo">
            <span class="brand-copy">BHARATIYA SWATANTRA SHIKSHAN SANGH<small>An Institution With Global Reach</small></span>
        </a>
...
<footer class="pt-5 pb-3 mt-5">
    <div class="container">
        <div class="row g-4">
            <div class="col-md-5">
                <img src="{{ $logoUrl }}" alt="Bharatiya Swatantra Shikshan Sangh logo" class="footer-logo">
                <h5 class="text-white">Bharatiya Swatantra Shikshan Sangh</h5>
        ...
        <div class="small">© {{ date('Y') }} Bharatiya Swatantra Shikshan Sangh. All rights reserved.</div>
    </div>
</footer>
