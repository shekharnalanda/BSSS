...
@section('title','Our Institutions | Bharatiya Swatantra Shikshan Sangh')
@section('meta_description','Explore the institutions and projects of Bharatiya Swatantra Shikshan Sangh.')
...
<section class="page-hero">
    <div class="container">
        ...
        <p class="lead mb-0">A growing educational and digital ecosystem under Bharatiya Swatantra Shikshan Sangh.</p>
    </div>
</section>
