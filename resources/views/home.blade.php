...
<head>
    ...
    <title>Bharatiya Swatantra Shikshan Sangh</title>
    <meta name="description" content="Bharatiya Swatantra Shikshan Sangh - An Institution With Global Reach, working under Chandrashekhar & Narayan Educational Trust.">
    ...
    <meta property="og:site_name" content="Bharatiya Swatantra Shikshan Sangh">
    <meta property="og:title" content="Bharatiya Swatantra Shikshan Sangh">
    <meta property="og:description" content="Bharatiya Swatantra Shikshan Sangh - An Institution With Global Reach, working under Chandrashekhar & Narayan Educational Trust.">
    <meta property="og:url" content="https://bsss.mciedu.com/">
    <meta property="og:image" content="{{ asset('images/mci-logo.png') }}">
    <meta name="twitter:card" content="summary">
    <meta name="twitter:title" content="Bharatiya Swatantra Shikshan Sangh">
    <meta name="twitter:description" content="Bharatiya Swatantra Shikshan Sangh - An Institution With Global Reach, working under Chandrashekhar & Narayan Educational Trust.">
...
@if($newsItems->count())
<section class="section"><div class="container"><div class="d-flex flex-wrap justify-content-between align-items-end gap-3 mb-5"><div><div class="section-kicker">Latest Updates</div><h2 class="section-title display-6 mb-0">News & Events</h2></div><a href="/news-events" class="btn btn-outline-primary">View All</a></div><div class="row g-4">@foreach($newsItems as $item)<div class="col-md-6 col-lg-4"><article class="card h-100 border-0 shadow-sm rounded-4"><div class="card-body p-4"><div class="small text-success fw-bold">{{ optional($item->published_at)->format('d M Y') ?: 'MCI Update' }}</div><h3 class="h5 fw-bold mt-2">{{ $item->title }}</h3><p class="small-muted mb-0">{{ $item->excerpt }}</p></div></article></div>@endforeach</div></div></section>
@endif
@if($galleryItems->count())
<section class="section section-soft"><div class="container"><div class="d-flex flex-wrap justify-content-between align-items-end gap-3 mb-5"><div><div class="section-kicker">Highlights</div><h2 class="section-title display-6 mb-0">Gallery</h2></div><a href="/gallery" class="btn btn-outline-primary">View Gallery</a></div><div class="row g-4">@foreach($galleryItems as $item)<div class="col-md-6 col-lg-4"><div class="card border-0 shadow-sm rounded-4 overflow-hidden h-100"><img src="{{ $item->image }}" alt="{{ $item->title }}" style="height:230px;object-fit:cover" class="w-100"><div class="card-body"><h3 class="h6 fw-bold mb-1">{{ $item->title }}</h3>@if($item->caption)<p class="small-muted mb-0">{{ $item->caption }}</p>@endif</div></div></div>@endforeach</div></div></section>
@endif
...
<section class="section pt-0"><div class="container"><div class="cta d-lg-flex align-items-center justify-content-between gap-4"><div><div class="text-uppercase fw-bold opacity-75 mb-2">Connect with MCI</div><h2 class="fw-bold mb-2">Looking for admission, training or institutional information?</h2><p class="mb-0 opacity-75">Contact Bharatiya Swatantra Shikshan Sangh and we will guide you to the right institution or service.</p></div><div class="mt-4 mt-lg-0"><a href="/contact" class="btn btn-light btn-lg fw-bold">Send Enquiry</a></div></div></div></section>
<footer class="footer"><div class="container"><div class="row g-4"><div class="col-lg-5"><img src="{{ asset('images/mci-logo.png') }}" alt="Bharatiya Swatantra Shikshan Sangh logo" class="footer-logo"><h5>BHARATIYA SWATANTRA SHIKSHAN SANGH</h5><p>An Institution With Global Reach</p><p class="mb-1">Working under Chandrashekhar &amp; Narayan Educational Trust</p><p class="mb-0">MCI CAMPUS, Quamruddin Ganj, Bihar Sharif, Nalanda - 803101</p></div><div class="col-6 col-lg-3"><h5>Quick Links</h5><div class="d-grid gap-2"><a href="/about">About Us</a><a href="/institutions">Our Institutions</a><a href="/programs">Programs</a><a href="/news-events">News &amp; Events</a><a href="/gallery">Gallery</a></div></div><div class="col-6 col-lg-4"><h5>Contact</h5><p class="mb-1">7004773247</p><p class="mb-1">9334779133</p><p>mcieducationalgroup@gmail.com</p></div></div><hr class="border-secondary my-4"><div class="small">© {{ date('Y') }} Bharatiya Swatantra Shikshan Sangh. All rights reserved.</div></div></footer>
